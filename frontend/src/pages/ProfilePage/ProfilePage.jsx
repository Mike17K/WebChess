    ...
    <div className='max-w-6xl w-full mt-[100px] flex gap-4 justify-center align-middle'>
        <div className='w-[80%] flex flex-col gap-4 '>
            <div className='bg-main-black rounded p-4 flex gap-4'>
                <img src={profileData.avatar || `http://localhost:3000/assets/icons/profiles/profile-${1+Math.floor(6*Math.random())}.png`} alt='avatar' className='w-[200px] h-[200px] object-cover' />
                <div className='w-[40%]'>
                    <div className='text-[#ffffff] font-bold text-xl mt-4'>{profileData.name}mikekaipis</div>
