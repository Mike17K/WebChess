...
export default function PlayerLayout({bottomPlayer,player,timeRemaining}) {
    // player: {picture,name,rating}
  return (
    <div className={`w-full ${bottomPlayer?"mt-[18px]":"mb-[18px]"} relative `}>
        <button className={`h-[50px] w-[150px] absolute ${bottomPlayer?"top-0":"bottom-0"} left-0 p-1 shadow-orange-400 shadow-md hover:border-2 border-4 rounded-full transition-all flex bg-white`}>
